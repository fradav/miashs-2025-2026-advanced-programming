...
See [uv installation](https://docs.astral.sh/uv/getting-started/installation/) for your platform.
...
## running a script online with just a dependency
...
## running  script with a directory
...
# Running multiprocessing/asyncio code in jupyter/interactive session
