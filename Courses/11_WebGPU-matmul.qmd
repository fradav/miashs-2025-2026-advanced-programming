...
results_plots = {
  ...
  const throughputPlot = throughputData.length > 0
    ? Plot.plot({
        height: 260,
        marginBottom: 40,
        marginLeft: 70,
  ...
  color: { domain, range },
        marks: [
          Plot.lineY(throughputData, {
            x: "runNumber",
            y: "gpuGflops",
            stroke: "kernel"
          }),
          Plot.dot(throughputData, {
            x: "runNumber",
            y: "gpuGflops",
            fill: "kernel",
            stroke: "kernel",
    ...
    : html`<em>No GPU throughput measurements yet.</em>`

  const totalTimePlot = totalTimeData.length > 0
    ? Plot.plot({
        height: 260,
        marginBottom: 40,
        marginLeft: 70,
        ...
        y: {
          label: "Total wall-clock time (ms)"
        },
  color: { domain, range },
        marks: [
          Plot.lineY(totalTimeData, {
            x: "runNumber",
            y: "totalMs",
            stroke: "kernel"
          }),
          Plot.dot(totalTimeData, {
            x: "runNumber",
            y: "totalMs",
            fill: "kernel",
            stroke: "kernel",
    ...
    : html`<em>No total time measurements yet.</em>`
  ...
  container.append(html`<div style="font-weight:600;">GPU Throughput</div>`)
  container.append(throughputPlot)
  container.append(html`<div style="font-weight:600;">Completion Time</div>`)
  container.append(totalTimePlot)
  return container
}
```
