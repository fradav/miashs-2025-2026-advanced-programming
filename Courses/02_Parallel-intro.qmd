...
author:
  - name: François-David Collin
    email: francois-david.collin@umontpellier.fr
    affiliations: 
      - CNRS
      - IMAG
  - name: Ghislain Durif
...
![](d2-figures/strong-scaling.svg){ .noinvert width="570px" }

![](d2-figures/weak-scaling.svg){ .noinvert width="630px" }
...
![Multi-Processing](tikz-figures/multiprocessing_model.svg){ width="600px"}

![Multi-Threading](tikz-figures/multithreading_model.svg){ width="600px"}
