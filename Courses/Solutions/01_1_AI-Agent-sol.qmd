...
As simple mcp server requires to be just a complete one-liner script to run, simply create a new python file (e.g. `mcp_server.py`) and add the following code:
